...
document.addEventListener('DOMContentLoaded', function () {
   ...
   if (aboutLink) {
    ...
    const watchBtn = document.querySelector('.hero__buttons .btn-dark');
    if (watchBtn) {
        watchBtn.addEventListener('click', function (e) {
            e.preventDefault();
            if (worksLink) setActiveNav(worksLink);
    ...
    if (pricesLink && pricesModal) {
        ...
        pricesModal.addEventListener('click', function (e) {
            if (e.target === pricesModal) closePrices();
        });
    ...
    const sectionMap = [
        ...
        { id: '#clients', el: document.querySelector('#clients'), link: worksLink },
